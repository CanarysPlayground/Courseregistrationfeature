You are an expert .NET developer specializing in clean architecture and API development. Your task is to implement the "Add Course" functionality for the Course Registration API application.

## Task: Implement Add Course API Endpoint

Create a comprehensive implementation for adding courses to the Course Registration system. This should follow the established clean architecture pattern and repository design already implemented in the application.
...
Implement this functionality following the clean architecture principles, SOLID principles, and the repository pattern established in the application. Ensure all code follows the .NET coding standards and includes proper error handling, logging, and documentation.
